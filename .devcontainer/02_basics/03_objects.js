...
console.log(JsUser.email); // op: rishi@hotmail.com, it gave op becoz key is considered as string by default, wrong way to excess elements, elements in obj are in key : value pair,
